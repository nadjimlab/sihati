        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-3 pr-10 py-2.5 rounded-xl border-2 border-slate-300 text-xs sm:text-sm font-bold text-slate-900 placeholder:text-slate-400 bg-white focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 shadow-xs transition-all"
            />
          </div>
        </div>
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5 pt-1">
                    <span className="text-xs font-black text-slate-800 block">الصلاحيات الممنوحة:</span>
                    <div className="flex flex-wrap gap-1.5">
                      {mod.permissions.map((perm) => {
                        ...
                        return (
                          <span
                            key={perm}
                            className="px-2.5 py-1 rounded-lg bg-indigo-50 text-indigo-900 border border-indigo-200 text-xs font-bold flex items-center gap-1.5 shadow-2xs"
                          >
            ...
            <form onSubmit={handleSaveModerator} className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-slate-300 text-sm font-bold text-slate-900 placeholder:text-slate-400 bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 outline-none shadow-xs transition-all"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-300 text-sm font-mono font-bold text-slate-900 placeholder:text-slate-400 bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 outline-none shadow-xs transition-all"
                    required
                  />
                  <span className="text-[11px] text-slate-600 font-medium block">يستخدم لتسجيل الدخول في لوحة الإدارة</span>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="اكتب كلمة المرور أو PIN..."
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-300 text-sm font-mono font-bold text-slate-900 placeholder:text-slate-400 bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 outline-none shadow-xs transition-all"
                    required
                  />
                  <span className="text-[11px] text-slate-600 font-medium block">الرمز الذي سيدخل به المشرف</span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-slate-200">
                <label className="block text-xs sm:text-sm font-black text-slate-950">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="space-y-0.5">
                          <span className="text-xs sm:text-sm font-black block text-slate-900">{perm.label}</span>
                          <span className="text-xs text-slate-600 block leading-tight font-medium">{perm.description}</span>
                        </div>
                      </label>
                    );
                  })}
