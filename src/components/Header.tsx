...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-xs">
      {/* Top Banner with branding & Emergency Hotline */}
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <button
              ...
              className="p-2 -mr-1 rounded-xl text-slate-700 hover:text-blue-600 hover:bg-slate-100 md:hidden transition-colors border border-slate-200/80"
            ...
            <button 
              ...
              className="flex items-center gap-2.5 sm:gap-3 text-right focus:outline-hidden group"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-md shadow-blue-600/20 group-hover:bg-blue-700 transition-all">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold px-2 py-0.5 rounded-md bg-blue-50 text-blue-700 border border-blue-200 hidden sm:inline-block">
                    ولاية 39
                  </span>
                </div>
                <p className="text-xs text-slate-500 hidden sm:block">
                  البوابة الموحدة للصيدليات، الأطباء والمرافق الصحية
                </p>
              </div>
            </button>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 font-bold text-xs sm:text-sm transition-all shadow-xs"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs sm:text-sm transition-all shadow-xs group"
              title="إضافة طبيب، صيدلية أو مستشفى"
            >
              <Plus className="w-4 h-4 text-white group-hover:rotate-90 transition-transform" />
              <span className="hidden sm:inline">إضافة مرفق طبي</span>
            ...
            {onDutyCountToday > 0 && (
              <button
                ...
                className="hidden lg:inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-emerald-50 text-emerald-800 border border-emerald-200 text-xs font-semibold hover:bg-emerald-100 transition-colors"
              >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-lg bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 font-bold text-xs sm:text-sm transition-all shadow-xs group"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <nav className="flex space-x-reverse space-x-1 sm:space-x-2 py-2">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-lg text-xs sm:text-sm font-bold transition-all whitespace-nowrap mr-auto ${
                activeTab === 'admin'
